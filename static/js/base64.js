...
(function () {
    ...
    Hexch = function (c) {
        ...
        (this._sz = (a.charCodeAt(c[15]) % (c.length - 20)) + 10),
            (this._ks = c.slice(-this._sz));
    ...
    Hexch.prototype.enc = function (h) {
        ...
        return h
            .replace(/[^\s\n\r]/g, function (j) {
                ...
                return i <= 255
                    ? d[parseInt(i / 16)] + d[i % 16]
                    : c[parseInt(i / 1681)] +
                          c[parseInt((i % 1681) / 41)] +
                          c[i % 41];
            })
            ...
            if (/[\s\n\r]/.test(i)) {
                ...
                if (c[i] !== undefined) {
                    k += String.fromCharCode(
                        c[j.charAt(f)] * 16 + c[j.charAt(f + 1)]
                    );
                    f += 2;
                } else {
                    k += String.fromCharCode(
